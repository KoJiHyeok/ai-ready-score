...
const messages = {
  en: {
    report: {
      ...
      ignoredItems: 'Ignored root items',
      ignorePatterns: 'Ignore patterns',
      ignoredItem: '{path} ({type}, matched {pattern})',
    ...
    help: {
      ...
      ignore: 'Ignore root-level files or folders during scanning',
  ...
  ko: {
    ...
    report: {
      ...
      ignoredItems: '무시된 루트 항목',
      ignorePatterns: '무시 패턴',
      ignoredItem: '{path} ({type}, {pattern}와 일치)',
    ...
    help: {
      ...
      config: 'JSON 설정 파일에서 프로젝트별 검사를 읽습니다',
      ignore: '루트 항목을 검사에서 제외합니다',
